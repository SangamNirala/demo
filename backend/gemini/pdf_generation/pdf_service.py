...
IMPORTANT: Return ONLY the JSON object, no additional text."""
    ...
    def _create_pdf(
        ...
        student_info_data = [
            [Paragraph('<b>Name</b>', bold_body_style), Paragraph(name, body_style)],
            [Paragraph('<b>Roll Number</b>', bold_body_style), Paragraph(roll_no, body_style)],
            [Paragraph('<b>Course</b>', bold_body_style), Paragraph(course, body_style)],
            [Paragraph('<b>Year</b>', bold_body_style), Paragraph(year, body_style)],
        ]
        
        if 'familyIncome' in student_data:
            student_info_data.append([Paragraph('<b>Family Income</b>', bold_body_style), Paragraph(student_data['familyIncome'], body_style)])
        if 'parentEducation' in student_data:
            student_info_data.append([Paragraph('<b>Parent Education</b>', bold_body_style), Paragraph(student_data['parentEducation'], body_style)])
        if 'accommodation' in student_data:
            student_info_data.append([Paragraph('<b>Accommodation</b>', bold_body_style), Paragraph(student_data['accommodation'], body_style)])
        if 'distanceFromCollege' in student_data:
            student_info_data.append([Paragraph('<b>Distance from College</b>', bold_body_style), Paragraph(student_data['distanceFromCollege'], body_style)])
        ...
        if 'assignmentsSubmitted' in student_data:
            academic_data.append([Paragraph('<b>📝 Assignments Submitted</b>', bold_body_style), Paragraph(student_data['assignmentsSubmitted'], body_style)])
        ...
        if 'libraryVisits' in student_data:
            engagement_data.append([Paragraph('<b>📚 Library Visits</b>', bold_body_style), Paragraph(student_data['libraryVisits'], body_style)])
        if 'lastLMSLogin' in student_data:
            engagement_data.append([Paragraph('<b>💻 Last LMS Login</b>', bold_body_style), Paragraph(student_data['lastLMSLogin'], body_style)])
        if 'extracurricular' in student_data:
            engagement_data.append([Paragraph('<b>🎯 Extracurricular</b>', bold_body_style), Paragraph(student_data['extracurricular'], body_style)])
        if 'counselorVisits' in student_data:
            engagement_data.append([Paragraph('<b>🧠 Counselor Visits</b>', bold_body_style), Paragraph(student_data['counselorVisits'], body_style)])
        if 'feeStatus' in student_data:
            engagement_data.append([Paragraph('<b>💰 Fee Status</b>', bold_body_style), Paragraph(student_data['feeStatus'], body_style)])
